...
<html lang="id">
  ...
  <body>
    <div class="container">
      ...
      <p class="subtitle">
        Terima kasih telah berbelanja di Groceria. Tim kami sedang menyiapkan
        bahan segar terbaik untuk Anda.
      </p>
      ...
      <div class="content">
        ...
        <div class="right">
          ...
          <div class="card">
            ...
            <div class="saving">💰 Hemat Rp 2.000 dari budget Anda</div>
          </div>
          ...
          <div class="card">
            ...
            <p class="courier">Kurir: Groceria Express</p>
          </div>
        </div>
      </div>

      <a href="#" class="back">Kembali ke Beranda Belanja →</a>
    </div>
  </body>
</html>
